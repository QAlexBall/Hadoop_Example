    ...
    if soup.findAll(name='meta', attrs={"name": "keywords"}):
        ...
        if priceInfo is not None:
            ...
            with open(resultPath + fileName, "a") as goodInfo:
                ...
                print(good_Name + " " + good_Price.split("\"")[1])
                goodInfo.write(good_Name + "--,--" + good_Price.split("\"")[1] + "\n")
...
firstPageURL = "https://item.jd.com/10375029868.html"
...
totalUrlList = ["https://item.jd.com/10653224883.html", firstPageURL]
